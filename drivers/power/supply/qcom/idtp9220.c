...
int program_fw(struct idtp9220_device_info *di, u16 destAddr, u8 *src, u32 size) {
	...
	di->bus.write(di, 0x0400, 0x00);        // initialize buffer
...
static int fod_over_write(struct idtp9220_device_info *di, int mode)
{
	...
	case EPP_BASE_VOL:
		...
		di->bus.write(di, 0x69, 0x3E);
		di->bus.write(di, 0x6A, 0x85);
		di->bus.write(di, 0x6B, 0x4D);
		di->bus.write(di, 0x6C, 0x89);
		di->bus.write(di, 0x6D, 0x43);
		di->bus.write(di, 0x6E, 0x86);
		di->bus.write(di, 0x6F, 0x55);
		di->bus.write(di, 0x70, 0x86);
		di->bus.write(di, 0x71, 0x5C);
		di->bus.write(di, 0x72, 0x86);
		di->bus.write(di, 0x73, 0x60);
		ret = 1;
		break;
	case BPP_PLUS_VOL:
		...
		break;
	case FULL_VOL:
		di->bus.write(di, 0x68, 0x94);
		di->bus.write(di, 0x69, 0x28);
		di->bus.write(di, 0x6A, 0x94);
		di->bus.write(di, 0x6B, 0x1F);
		di->bus.write(di, 0x6C, 0x94);
		di->bus.write(di, 0x6D, 0x15);
		di->bus.write(di, 0x6E, 0x94);
		di->bus.write(di, 0x6F, 0x15);
		di->bus.write(di, 0x70, 0x94);
		di->bus.write(di, 0x71, 0x0F);
		di->bus.write(di, 0x72, 0x94);
